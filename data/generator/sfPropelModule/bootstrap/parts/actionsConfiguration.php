...
<?php unset($this->config['list']['object_actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['list']['actions']) ? $this->config['list']['actions'] : array('_new' => null, 'filters'=>array('label'=>'Filters'), 'reset'=>array('label'=>'Reset filter'))) ?>;
