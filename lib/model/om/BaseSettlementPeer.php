...
abstract class BaseSettlementPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ContractId', 'Date', 'Interest', 'Paid', 'Capitalized', 'Balance', 'BalanceReduction', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'contractId', 'date', 'interest', 'paid', 'capitalized', 'balance', 'balanceReduction', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CONTRACT_ID, self::DATE, self::INTEREST, self::PAID, self::CAPITALIZED, self::BALANCE, self::BALANCE_REDUCTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'contract_id', 'date', 'interest', 'paid', 'capitalized', 'balance', 'balance_reduction', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ContractId' => 1, 'Date' => 2, 'Interest' => 3, 'Paid' => 4, 'Capitalized' => 5, 'Balance' => 6, 'BalanceReduction' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'contractId' => 1, 'date' => 2, 'interest' => 3, 'paid' => 4, 'capitalized' => 5, 'balance' => 6, 'balanceReduction' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CONTRACT_ID => 1, self::DATE => 2, self::INTEREST => 3, self::PAID => 4, self::CAPITALIZED => 5, self::BALANCE => 6, self::BALANCE_REDUCTION => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'contract_id' => 1, 'date' => 2, 'interest' => 3, 'paid' => 4, 'capitalized' => 5, 'balance' => 6, 'balance_reduction' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
