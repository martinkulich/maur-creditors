...
abstract class BaseReportPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Code', 'Name', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('code', 'name', ),
		BasePeer::TYPE_COLNAME => array (self::CODE, self::NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('code', 'name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Code' => 0, 'Name' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('code' => 0, 'name' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::CODE => 0, self::NAME => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('code' => 0, 'name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		$criteria->addSelectColumn(ReportPeer::CODE);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseReportPeer', $criteria, $con);
		}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReportPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseReportPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReportPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseReportPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReportPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseReportPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ReportPeer::CODE);
			$selectCriteria->add(ReportPeer::CODE, $criteria->remove(ReportPeer::CODE), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReportPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseReportPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ReportPeer::CODE, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ReportPeer::CODE, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ReportPeer::DATABASE_NAME);
			$criteria->add(ReportPeer::CODE, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseReportPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
