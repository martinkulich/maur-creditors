...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_bar">
    <?php include_partial('contract/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('contract/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'currency'=>$currency)) ?>
