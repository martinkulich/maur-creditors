...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <?php include_partial('regulation/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'sums'=>$sums, 'currency'=>$currency)) ?>
    <ul class="sf_admin_list_actions">
      <?php include_partial('regulation/list_batch_actions', array('helper' => $helper)) ?>
      <?php include_partial('regulation/list_actions', array('helper' => $helper, 'pager'=>$pager, 'showResetFilter'=>$showResetFilter)) ?>
    </ul>
  </div>
